#!/usr/bin/env python
"""
a script for getting materials from an API
"""
...
api_search_url = 'https://royalalbertamuseum.ca/search/node?keys=war'

# This creates a dictionary called 'params' and sets values for the API's mandatory parameters
params = {
    'proxtext': 'war' # Search for this keyword
}
...
print('Here\'s the formatted url that gets sent to the RAM API:\n{}\n'.format(response.url))
